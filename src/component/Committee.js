    ...
    <div className='hero_Committee'>
      ...
      <div className="Committee-container">
        <div className="Committee-Details">
          ...
          <img src={Img} alt="f" width="9" height="9" /> Prof. (Dr.) Xin-She Yang, Middlesex University, Hendon, London
          <hr />
          <br />
          ...
          <img src={Img} alt="f" width="9" height="9" /> Prof. (Dr.) Ambar Dutta, Amity University Kolkata, India<br />
          <img src={Img} alt="f" width="9" height="9" /> Prof. (Dr.) Pradeep Kumar Tiwari, Manipal University Jaipur, India<br />
          <img src={Img} alt="f" width="9" height="9" /> Prof. (Dr.) Bibudhendu Pati, Rama Devi Women's University, India<br />
          <img src={Img} alt="f" width="9" height="9" /> Prof. (Dr.) Chhabi Rani Panigrahi, Rama Devi Women's University, Bhubaneswar, India<br />
          <img src={Img} alt="f" width="9" height="9" /> Prof. (Dr.) Prashant R. Nair, Amrita Vishwa Vidyapeetham, India<br />
          <img src={Img} alt="f" width="9" height="9" /> Prof. (Dr.) Govinda K, Associate Professor,VIT, India<br />
          <img src={Img} alt="f" width="9" height="9" /> Prof. (Dr.) Anuranjan Misra, Greater Noida Institute of Technology, Greater Noida, India<br />
          <img src={Img} alt="f" width="9" height="9" /> Prof. (Dr.) Prasanta K. Jana, Indian Institute of Technology (ISM) Dhanbad, India<br />
          <img src={Img} alt="f" width="9" height="9" /> Prof. (Dr.) Dakshina Ranjan Kisku, National Institute of Technology Durgapur, India<br />
          <img src={Img} alt="f" width="9" height="9" /> Prof. (Dr.) Anand Sharma, SET, MUST, Lakshmangarh, India<br />
          <img src={Img} alt="f" width="9" height="9" /> Prof. (Dr.) Sambit Kumar Mishra, Gandhi Institute for Education and Technology, Baniatangi, Bhubaneswar, Odisha, India<br />
          <img src={Img} alt="f" width="9" height="9" /> Prof. (Dr.) Pradeep Reddy Gogulamudi, VIT-AP University, India<br />
          <img src={Img} alt="f" width="9" height="9" /> Prof. (Dr.) Rakesh Chandra Balabantaray, IIIT Bhubaneswar, India<br />
          <img src={Img} alt="f" width="9" height="9" /> Prof. (Dr.) S. Devapriya Dewasurendra, Faculty of Engineering, University of Peradeniya, Peradeniya, Sri Lanka<br />
          <img src={Img} alt="f" width="9" height="9" /> Prof. (Dr.) Soma Barman (Mandal), Institute of Radio Physics &amp; Electronics, University of Calcutta, India<br />
          <img src={Img} alt="f" width="9" height="9" /> Prof. (Dr.) Kunal Das, Acharya Prafulla Chandra College, New Barrakpur (Govt. of West Bengal aided), India<br />
          <img src={Img} alt="f" width="9" height="9" /> Prof. (Dr.) Chintan Mandal, Jadavpur University, Kolkata, India<br />
          <img src={Img} alt="f" width="9" height="9" /> Prof. (Dr.) Rashmi Soni, Oriental University, Indore, India<br />
          <img src={Img} alt="f" width="9" height="9" /> Prof. (Dr.) Tamilselvi P, Faculty of Engineering and Technology, Jain (Deemed to be) University, Bangalore, India<br />
          <img src={Img} alt="f" width="9" height="9" /> Prof. (Dr.) A M Sudhakara, Pas3cyberlabs, Mysore, India<br />
          ...
          <img src={Img} alt="f" width="9" height="9" /> Prof. (Dr.) Debashis De, Maulana Abul Kalam Azad University of Technology, India<br />
          ...
          <strong>Hospitality and Transport Chairs</strong><br />
          <img src={Img} alt="f" width="9" height="9" /> Prof. Subhadip Chandra, Institute of Engineering &amp; Management, India<br />
          <img src={Img} alt="f" width="9" height="9" /> Prof. Nirmal Das, Institute of Engineering &amp; Management, India<br />
          <img src={Img} alt="f" width="9" height="9" /> Prof. Pabak Indu, Institute of Engineering &amp; Management, India <br/>
